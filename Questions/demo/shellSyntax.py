...
class Sh(tpg.VerboseParser):
	...
	START/c -> (line_separator|word_separator)?
        ...
        REPLACEMENT1/$Replacement(r)$ -> dollar open_brace  SEQUENCE/r close_brace ;
        REPLACEMENT2/$Replacement(r)$ -> '`' SEQUENCE/r '`' ;
...
#                          | "[^']"/x $ d+=x $ )* "'" ;
        ...
        SUBSHELL/s -> open_brace (line_separator|word_separator)?
                      SEQUENCE/c$s=SubShell(c)$
                      (line_separator|word_separator)? close_brace
