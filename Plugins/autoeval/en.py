...
translations = {
    'intro_problem' : "Problems are in limited time (less than one hour) and can not be paused. The only way to start another problem is to give up or answer successfuly. Click on the button to start:",
